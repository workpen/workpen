...
pub use guard::{
    ...
    PathGuardKind, check_dests, resolve_extra_root, resolve_extra_root_pair,
...
pub use wrap::{
    ...
    is_denied_child_env, kernel_supported, process_jail, require_applied, scrub_child_command,
